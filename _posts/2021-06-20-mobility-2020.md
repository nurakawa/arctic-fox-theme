...
// Initiate selectedGroup, selectedCountry, calendar heatmap
    ...
    <li> Even in warmer countries, people walked less during times of Covid restrictions. Time spent in parks increases dramatically in the summer for nearly all countries, likely due to warmer weather. </li>
    <li> In some countries, notably Belgium and Netherlands, people spent more time at home on weekdays, even when stay-at-home response measures were temporarily lifted. This is likely due to teleworking, a response present in nearly all countries. </li>
    </ul>
    <h3>The Data</h3>
